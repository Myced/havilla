        ...
        <ul class="slides">
            <li class="has-overlay">
                ...
                <div class="slider-content">
                    <div class="container">
                        <h2> Havilla Ministries International </h2>
                        <p> Witness the <strong>Greatness of the Lord</strong>
                            <br> Bringing Souls to Christ </p>
                        <a class="btn primary-btn"> KNOW MORE <i class="fa fa-angle-right"></i> </a>
                    </div>
                </div>
            </li>
            <li class="has-overlay">
                <img src="/site/images/slider2.jpg" alt="Slider 2" />
